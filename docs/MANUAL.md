...
| ✕ 非推奨 | AVX2非対応の古いCPU・N100等の省電力CPU | 連続して喋ると認識が追いつかず、字幕の遅れが溜まっていきます（下の実測） |
...
> **実測例**（テスター報告・いずれもソロ・英訳OFF・通常精度）:
> - **Intel Core i7-13700HX**（16コア・○の帯）— 認識中のCPU使用率 約40%。英訳ON＋高精度にしても数%の上乗せ程度
> - **Intel N100**（省電力4コア・✕の帯）— 短い発話には反応するものの CPU 90%超に張り付き、
>   連続して喋ると字幕の遅れが蓄積していき実用不可。メモリは約1.3GB（メモリではなくCPU馬力がボトルネック）
