...
| 翻訳先 | 英語 / 中国語（中国大陸・台湾・香港）/ インドネシア語 / 日本語 / 韓国語〔試験的〕 |
...
|---|---|
| 句読点 | 確定文に「、」「。」を自動付与 |
| 翻訳 | 確定字幕の下に翻訳を併記。翻訳先は「アプリ設定 → 翻訳」で切替（[6章](#6-翻訳の併記)） |
...
翻訳先は「アプリ設定 → 翻訳」で切り替えられます（コックピットのチップ名も翻訳先に合わせて変わります）。

| 翻訳先 | 補足 |
|---|---|
| 英語（既定） | 「配信→stream」「スパチャ→Super Chat」など配信用語は正しく訳される組み込み辞書つき。人名などは「英訳を固定する単語」で訳を固定できます |
| 中国語（簡体字・中国大陸） | 「配信→直播」など配信用語に対応。初回選択時に翻訳モデルを自動DL（約470MB） |
| 中国語（繁体字・台湾） | 簡体字訳を台湾正体字と台湾で一般的な語彙へ変換します |
| 中国語（繁体字・香港） | 簡体字訳を香港繁体字へ変換します |
| インドネシア語 | M2M-100で日本語から直接翻訳します |
