...
| **リリックビデオ（散らし）** | 歌枠・BGV的な演出。画面全体に歌詞が散ります |
...
- 分割「フレーズごと」=歌詞らしい間、「単語ごと」=画面が一気ににぎやかに
- **サイズばらつき・回転ゆらぎを上げるほど「手書きMV感」**が出ますが、読みやすさは下がります。まず初期値から少しずつ
- 同時表示数×表示時間が多すぎると画面が文字で埋まります。歌のテンポに合わせて調整
